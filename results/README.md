The csv files contain the results (MAE, RMSE) of the comparison between the proposed EBCR method and the state-of-the-art CF models. Note that the evaluation is based on a
